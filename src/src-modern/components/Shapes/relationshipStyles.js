// src/components/Shapes/relationshipStyles.js
...
export const PARENT_RELATIONSHIP_TYPES = [
  ...
  'complicated',  
  'on-off',       
  'toxic',        // Toxic relationships can have children
  'dependency',   // Dependent relationships can have children
  'codependent',  // Codependent relationships can have children
  
  // Special family relationships
  'adoption',     // Adoption relationships
  'step-relationship', // Step-relationships can have children
  
  // Emotional relationships that might have children
  'close',        // Very close relationships might have children
  'love',         // Love relationships can have children
  'best-friends', // Best friends who have children together
  
  // Social services relationships
  'caregiver',    // Caregiver relationships might have children
  'supportive'    // Supportive relationships can have children
];
